 ...
 * SEPARATE from GarzaHive's own contacts CRM (create_contact/get_contact/…): these
 * never enter GarzaHive's store. Typical use is looking up a phone number to hand
