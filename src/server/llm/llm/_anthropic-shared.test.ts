...
import type { GarzaHiveMessage, LLMModel, GarzaHiveTool, SystemPrompt } from '@/server/llm/llm/types'

// ─── messagesToAnthropic ─────────────────────────────────────────────────────

describe('messagesToAnthropic', () => {
  it('converts a simple text user message', () => {
    const msgs: GarzaHiveMessage[] = [
...
describe('toolsToAnthropic', () => {
  ...
  it('maps garzahive fields to anthropic ones', () => {
