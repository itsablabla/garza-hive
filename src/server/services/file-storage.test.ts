...
describe('buildShareUrl contract', () => {
  ...
  it('constructs share URL from public URL and token', () => {
    expect(buildShareUrlLocal('https://garzahive.example.com', 'abc123'))
      .toBe('https://garzahive.example.com/s/abc123')
  })
  ...
  it('handles long hex tokens', () => {
    ...
    const url = buildShareUrlLocal('https://garzahive.example.com', token)
