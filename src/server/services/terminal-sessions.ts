...
/** Dedicated tmux server socket so GarzaHive's sessions and global options
...
export function isTmuxAvailable(): boolean {
  if (process.env.GARZAHIVE_TERMINAL_TMUX === 'off') return false
