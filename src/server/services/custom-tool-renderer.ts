 ...
 * HOST's single React instance — exposed on the page as `window.__GARZAHIVE_REACT__`
 ...
 *   - A banner `const React = window.__GARZAHIVE_REACT__;` backs that free `React`
...
;(globalThis as Record<string, unknown>).__GARZAHIVE_SSR_REACT__ = React
;(globalThis as Record<string, unknown>).__GARZAHIVE_SSR_REACT_DOM__ = ReactDOM
 ...
 * (`__GARZAHIVE_SSR_REACT__` / `__GARZAHIVE_SSR_REACT_DOM__`) that have no such side
...
const CLIENT_GLOBALS: RendererGlobals = {
  react: 'window.__GARZAHIVE_REACT__',
  reactDom: '(window.__GARZAHIVE_REACT_DOM__ || {})',
}

const SSR_GLOBALS: RendererGlobals = {
  react: 'globalThis.__GARZAHIVE_SSR_REACT__',
  reactDom: '(globalThis.__GARZAHIVE_SSR_REACT_DOM__ || {})',
}
 ...
 * for the CLIENT. The output reads the host React off `window.__GARZAHIVE_REACT__`.
 ...
 * read off `globalThis.__GARZAHIVE_SSR_REACT__` / `globalThis.__GARZAHIVE_SSR_REACT_DOM__`
