...
export const createMiniAppTool: ToolRegistration = {
  ...
  create: (ctx) =>
    tool({
      description:
        'Create a new mini web app displayed in the GarzaHive sidebar. ' +
        ...
        'Bare ES imports (react, @garzahive/react, …) resolve ONLY via an app.json import map, ' +
          ...
          if (templateData) {
            ...
            if (
              ...
              warning =
                ...
                'A default app.json was created with: react, react-dom/client, @garzahive/react, ' +
                '@garzahive/components. Edit it via write_mini_app_file if you need different ' +
