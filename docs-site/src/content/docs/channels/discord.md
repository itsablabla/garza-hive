...
5. In GarzaHive, go to your Agent's **Channels** tab
6. Click **Add Channel**, select **Discord**
7. Paste your bot token. It will be encrypted in GarzaHive's vault
...
- **Inbound:** GarzaHive maintains a persistent WebSocket connection to Discord's Gateway. It receives message events, ignores its own messages, and routes incoming messages to the Agent.
