 ...
 *   2. Qualified slug#number  — `garzahive#42`
...
export function ticketResolutionMessage(
  ...
  switch (code) {
    case 'INVALID_TICKET_REF':
      return `Invalid ticket reference "${context.raw ?? ''}". Expected a UUID, a qualified id like "garzahive#42", or a bare number like "#42".`
