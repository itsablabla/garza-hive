    ...
    return (
      <div className="surface-base flex min-h-screen items-center justify-center">
        <div className="text-center animate-fade-in">
          <GarzaHiveLogo size={56} title={null} className="mx-auto mb-3" />
          <h1 className="text-4xl font-extrabold text-foreground">GarzaHive</h1>
      ...
      <div className="surface-base flex min-h-screen items-center justify-center px-4">
        ...
        <div className="relative z-10 w-full max-w-md animate-fade-in-up">
          <div className="glass-strong rounded-2xl p-8 shadow-lg text-center space-y-4">
            <GarzaHiveLogo size={56} title={null} className="mx-auto" />
            <h1 className="text-3xl font-extrabold text-foreground">GarzaHive</h1>
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in-up">
        <div className="glass-strong rounded-2xl p-8 shadow-lg">
          ...
          <div className="mb-6 text-center">
            <GarzaHiveLogo size={64} title={null} className="mx-auto mb-3" />
            <h1 className="text-3xl font-extrabold text-foreground">GarzaHive</h1>
