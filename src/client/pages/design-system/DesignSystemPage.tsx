...
const NAV_SECTIONS = [
  ...
  { id: 'garzahive-patterns', label: 'GarzaHive Patterns', icon: Shapes },
...
export function DesignSystemPage() {
        ...
        <header className="sticky top-0 z-50 surface-header border-b">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold gradient-primary-text">GarzaHive Design System</h1>
              ...
              <div className="grid gap-8 lg:grid-cols-2">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="i2" defaultValue="Hello GarzaHive" />
                  </div>
                  <div className="space-y-2">
 ...
 <Badge variant="secondary" size="xs">3 pending</Badge>
            ...
            {/* ─── GARZAHIVE PATTERNS ──────────────────────────────── */}
            <Section id="garzahive-patterns" title="GarzaHive Patterns">
 ...
 <Badge variant="secondary" size="xs" className="shrink-0">2</Badge>
            ...
            <div className="border-t pt-8 text-center">
              <p className="text-sm text-muted-foreground">
                <span className="gradient-primary-text font-bold">GarzaHive</span> &mdash; {currentPalette?.name ?? 'Aurora'} Design System &middot; 32 components &middot; Dev only.
              </p>
            </div>
          </main>
        </div>
